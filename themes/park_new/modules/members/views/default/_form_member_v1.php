...
?>
    ...
    <div class="parkclub-new-member" id="form_membership">
        <div class="parkclub-newm-left parkclub-shadow">
            ...
            <div class="take_picture" id="take_picture<?php echo $form_element;?>" style="display: none;padding: 20px;">
                ...
                <div class="view_picture" id="view_picture<?php echo $form_element;?>" style="display: block;">
                    <div class="view_picture_after" id="view_picture_after<?php echo $form_element;?>" style="display: block;">
                        <img id="member_img<?php echo $form_element;?>" src="<?php echo Yii::$app->urlManager->baseUrl; ?>/image/park_new/unknown.png" />
                        </div>
            ...
            <!-- END MODAL WELCOME -->
                ...
                <fieldset>
                    ...
                    <?php 
                    $district_arr = array(0=>Yii::t('app', 'Choose Source')) + ListSetup::getItemByList('souce');
                    echo $ListSetup->getSelectOptionList("souce",$district_arr,"Member[".$form_element."][member_profession]",false,false,false,'');
                    ?>
        ...
        <div class="parkclub-newm-right parkclub-shadow">
                ...
                <fieldset>
                    ...
                    <div hidden="" style="color:#a94442" class="parkclub-newm-error" id="error_membership_type_<?php echo $form_element;?>">Membership Type can not be blank</div>
                     ...
                     <div class="card_no_dispaly" style="padding-bottom: 12px; padding-top: 12px; display: none;">
                     ...
                     <div class="card_no_dispaly" style="padding-top: 12px; display: none;">
                        ...
                        <input id="card_no_value_<?php echo $form_element;?>" type="text"  readonly="" value="<?php echo $card_no; ?>" name="Member[<?php echo $form_element;?>][membership_code]"  /> 
