               ...
               <div class="parkclub-invoice">
                   ...
                   <div class="parkclub-newm ">
                       <fieldset>
                           ...
                           <?= $form->field($model, 'membership_type_id')->dropDownList($arr_membershipType,['onChange'=>"check_membership_code()" ])->label(false) ?>
                           ...
                           <label for=""><?php echo Yii::t('app','Status'); ?>:</label>
                            <?= $form->field($modelMemberShip, 'membership_status')->dropDownList($modelMemberShip->getArrayStatus(),['onChange'=>"check_membership_code()" ],['options' => ['Inactive' => ['selected'=>true]]])->label(false) ?>
                            <div hidden="" class="error-form" style="color:#a94442" id="error_membership_type"><?php echo Yii::t('app','Membership Type can not be blank'); ?></div>
                           
                           <label for=""><?php echo Yii::t('app','Card No'); ?>:</label>
                            <?= $form->field($modelMemberShip, 'membership_code')->textInput(['value'=>$next_card_no,'onkeyup'=>'check_membership_code(this.value)'])->label(false) ?>
                           ...
                           <?= $form->field($modelMemberShip, 'membership_barcode')->textInput(['value'=>$next_agreementno,'onkeyup'=>'check_membership_code(this.value)','readonly'=>true])->label(false) ?>
                           <div hidden="" class="error-form" style="color:#a94442" id="error_membership_code"></div>
...
//        var membership_code = $('#membership-membership_code').val();
    ...
    function check_membership_code(membership_code)
    {
