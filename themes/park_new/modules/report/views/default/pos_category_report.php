...
?>
  <table class="table">
    ...
    <tbody>
     ...
     <?php echo '<a style = "padding-left: 45%;" href='.Yii::$app->urlManager->createUrl('/report/default/pos-report-category-pdf?start_date='.$selected_start_date.'&end_date='.$selected_end_date).' ><button class="btn btn-success" style = "background-color: rgb(50, 205, 139);">'.Yii::t('app', 'Print PDF').'</button> </a>'; 
	 echo '<a href='.Yii::$app->urlManager->createUrl('/report/default/pos-report-category-excel?start_date='.$selected_start_date.'&end_date='.$selected_end_date).' ><button class="btn btn-success" style = "background-color: rgb(50, 205, 139);">'.Yii::t('app', 'Export Excel').'</button> </a>';
	 ?>
  </div>
</div>
