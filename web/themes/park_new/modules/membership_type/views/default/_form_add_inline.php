...
$drop_tax = $ListSetup->getSelectOptionList('Tax',false,false,"",false,'price_tax','form-control select-none');
...
<tr >
    ...
    //            'value' => '',
        ...
        <td style="width:15%">
            <button type="button" onclick="savePrice(<?php echo $_POST['count']; ?>);return false;" class="btn btn-success btn-small"><?php echo Yii::t('app', 'Save');?></button>
