    ...
    <div class="parkclub-new-member">
        ...
        <div class="parkclub-newm-right parkclub-shadow" style="min-height: 600px;">
            <fieldset>
                ...
                <label for=""><?php echo Yii::t('app', 'Sales code'); ?></label>
                <input  value="<?php echo $nextManage->getDisplaySaleCode();?>" type="text" name="Member[sale_code]"  >
                <div>
                        <div class="nav-title"><?php echo Yii::t('app', 'Login Account'); ?></div>
                        <label for=""><?php echo Yii::t('app', 'Send email to member');?></label>
                        <input type="checkbox" style="width: auto; height: 10px;margin-left:10px" name="Member[sendmail]" ><br>
                        <label for="" style="margin-top: 5px;"><?php echo Yii::t('app', 'Username');?></label>
                        <input type="text" name="Member[username]" >
                        <div hidden="" style="color:#a94442" ><?php echo Yii::t('app', 'Username can not be blank');?></div> 
                        <label for=""><?php echo Yii::t('app', 'Password');?></label>
                        <input type="text" name="Member[password]" value="<?php echo $nextManage->getDisplaySaleCode(); ?>" >
                        <div hidden="" style="color:#a94442" ><?php echo Yii::t('app', 'Password can not be blank');?></div> 
                    </div>
            </fieldset>
                ...
                $.ajax({
                        ...
                        success: function (data) {
                            ...
                            else
                            {
                                ...
                                $('input[name="Member[username]').val(value);
                            }
                        }
                });
            }
