...
{
    $discount_arr=$ListSetup->Discount;
...
<h3 style="font-size: 30px; text-align: center"><?php echo Yii::t('app','Receipt'); ?> <?php echo $model->invoice_no;?> </h3> 

    <table style="float:left; font-size: 16px;">
        <tr>
            <td style="font-weight: bold"><span ><?php echo Yii::t('app','Customer'); ?>:</span></td>
            <td> <?php echo $Member->getMemberFullName($Member->member_id);?></td>
        ...
        <tr>
            <td style="font-weight: bold;"><span ><?php echo Yii::t('app','Address'); ?>:</span></td><td> <?php echo $Member->member_address;?></td>
        ...
        <tr>
            <td style="font-weight: bold"><span><?php echo Yii::t('app','Mobile'); ?></span></td><td><?php echo $Member->member_mobile;?></td>
            <td style="font-weight: bold"><p><?php echo Yii::t('app','Saler'); ?>:</p></td>
        ...
        <tr>
            <td style="font-weight: bold;"><span ><?php echo Yii::t('app','Email'); ?>:</span></td><td> <?php echo $Member->member_email;?></td>
...
<tr class="dautien invoice" style="background-color: #5bb75b;">
    ...
    <tr>
        ...
        <td style="text-align: center;" ><?php echo number_format($quantity,0,",","."); ?></td>
...
<br/><br/>
<table class="table" id="table_payment" style="text-align: left;width: 100%;font-size: 16px" cellspacing="4">
    <tr class="dautien invoice" style="background-color: #5bb75b;">
