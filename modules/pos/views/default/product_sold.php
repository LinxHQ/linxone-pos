...
<div  id="members-index" class="parkclub-wrapper parkclub-wrapper-search members-index">
    ...
    echo Select2::widget([
        ...
        'options' => [
            'id'=>'product',
            'data'=>  yii\helpers\Url::toRoute(['/pos/default/product-item', 'product'=>$product_selected]),
...
<?php Pjax::end(); ?>
            <div style="margin-top: 2%; text-align: center;">
              ...
              <?php echo '<a href='. yii\helpers\Url::toRoute(['/pos/default/pos_report_product_sold', 'product'=>$product_selected]).' ><button class="btn btn-success" style = "background-color: rgb(50, 205, 139);" >'.Yii::t('app', 'Export Excel').'</button> </a>'; ?>
            </div>
        </div>
    </div>
</div>
<script>
    function search_product_sold()
    {
        ...
        console.log($('#product').attr('data'));
        window.location.href =  '<?php echo yii\helpers\Url::toRoute(['/pos/default/product-item'] )?>' + "&product=" +product;
