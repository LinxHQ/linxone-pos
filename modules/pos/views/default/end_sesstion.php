...
<div class="parkclub-subtop-bar">
    <div class="parkclub-nameplate"><div class="parkclub-iconbg"><a href="<?php echo yii\helpers\Url::toRoute(['/pos/default/index']); ?>" ><img src="<?php echo Yii::$app->urlManager->baseUrl; ?>/image/park_new/payment.png" alt=""></div> <h3><?php echo Yii::t('app','Session Report') ?></h3></a><a style="margin-left: 40%;" href="<?php echo Yii::$app->urlManager->createUrl('/pos/default/product-item'); ?>" class="btn btn-primary"><?php echo Yii::t('app', 'Sold items') ?></a><a style="margin-left: 1%;" onclick="end_sesstion(); return false;" class="btn btn-primary"><?php echo Yii::t('app', 'End session') ?></a></div>
</div>
