...
<div class="pos-default-index">
    <div class="parkclub-subtop-bar">
        ...
        <a href="<?php echo Yii::$app->urlManager->createUrl('/pos/department/index') ?>" class="btn btn-primary"  ><?php echo Yii::t('app', 'BRANCH') ?> <span class="badge" style="color: #ce1515" id="new_order_count"></span></a>
         </div>
    </div>
